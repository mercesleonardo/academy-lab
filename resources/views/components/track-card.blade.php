            ...
            <div class="p-6 sm:p-8">
                ...
                <div class="flex items-center gap-4 text-sm text-neutral-300">
                    <div class="flex items-center gap-2">
                        ...
                        <span >{{ $track->productTrackPaths->count() }} Caminhos</span>
                    </div>
                    ...
                    <div class="flex items-center gap-2">
                        ...
                        <span class="text-xs">{{ \Carbon\CarbonInterval::seconds($track->productTrackPaths->sum('path.duration'))->cascade()->forHumans() }}</span>
                    </div>
                </div>
